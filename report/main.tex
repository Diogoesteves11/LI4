...
A interface do cliente foi projetada seguindo os princípios de \textit{User-Centered Design}, focando-se na simplicidade e na rapidez de acesso às funcionalidades críticas.

\begin{itemize}
    \item \textbf{Dashboard:} Centraliza as métricas do utilizador, exibindo o número de veículos registados e o estado das intervenções em curso através de um layout responsivo desenvolvido com \texttt{Tailwind CSS}.
    \begin{figure}[!h]
        \centering
        \includegraphics[width=\textwidth]{images/HomeCliente.png} 
        \caption{Homepage do Cliente}
    \end{figure}   
    
    \item \textbf{Gestão de Ativos:} Conforme ilustrado na figura abaixo, é possível visualizar os registos e adicionar trotinetes através de Marca, Modelo e Número de Série.
     \begin{figure}[!h]
        \centering
        \includegraphics[width=\textwidth]{images/RegistoTrotinete.png} 
        \caption{Página de Registos de trotinetes}
    \end{figure}   
            
    \item \textbf{Agendamento de Serviços:} O sistema de marcação de diagnósticos permite ao cliente selecionar o veículo afetado e indicar a sintomatologia do problema, integrando-se diretamente com o fluxo de trabalho dos técnicos da oficina.
     \begin{figure}[!h]
        \centering
        \includegraphics[width=\textwidth]{images/AgendarDiagnostico.png} 
        \caption{Página de Agendamento de Diagnóstico}
    \end{figure}   
    \item \textbf{Histórico Financeiro:} A secção de faturas oferece uma visão clara das obrigações financeiras, permitindo ao cliente acompanhar os custos de manutenção e o histórico de pagamentos efetuados.
    \begin{figure}[!h]
        \centering
        \includegraphics[width=\textwidth]{images/FATURAS.png} 
        \caption{Página de Histórico Financeiro}
    \end{figure}   
...
\begin{figure}[H]
    ...
    \caption[Página de preenchimento de diagnóstico]{Página de preenchimento de diagnóstico}
...
\begin{figure}[H]
    ...
    \caption[Página de reparações]{Página de reparações}
    \label{fig:Páginareparações}
\end{figure}
\subsection{Interface Operador de Loja}
\subsection{Interface do Administrador}

\begin{figure}[!h]
    \centering
    \includegraphics[width=\textwidth, angle=90]{images/DashBoardADMIN.png} 
    \caption{Interface do Administrador}
\end{figure}
...
\begin{itemize}
    \item \textbf{Navegação de Gestão:} Um menu lateral esquerdo com acesso direto aos módulos cruciais de administração (Clientes, Reparações, Trotinetes e Definições) e uma barra superior com pesquisa e opções da conta de administrador.
    \item \textbf{Visão Geral da Operação:} Uma área central desenhada para exibir o estado atual do negócio num relance, contendo indicadores de desempenho e o resumo das atividades ou métricas mais recentes da plataforma.
\end{itemize}
