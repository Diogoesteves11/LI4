...
public class PecaRepository : iPecaRepository 
{
    ...
    {
        return await AtualizarDadosParcial(EAN, new { StockAtual = stock });
    }

    public async Task<bool> DesativarPeca(string EAN) 
    {
        return await AtualizarDadosParcial(EAN, new { Ativo = false });
    }

    public async Task<bool> AtivarPeca(string EAN) 
    {
        return await AtualizarDadosParcial(EAN, new { Ativo = true });
    }
